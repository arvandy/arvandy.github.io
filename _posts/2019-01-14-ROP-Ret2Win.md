...
<br>
<div align="justify">
Ret2win address is 0x08048659. This make the final payload become "A" * 44 + <ret2win_address> to overwrite the EIP. Below is a simple python script using pwntools to automate the process.</div>
